...
CREATE TABLE `tb_ordem_servico` (
  ...
  `id_tipo_ordem_servico` int(11) NOT NULL,
  `id_velocidade` int(11) DEFAULT NULL,
  `nu_ordem_servico` varchar(20) NOT NULL,
  ...
  `tp_figuracao_em_lista` int(11) DEFAULT NULL,
  ...
  KEY `fk_ordemservico_tipoordemservico_idx` (`id_tipo_ordem_servico`),
  ...
  CONSTRAINT `fk_ordemservico_tipoordemservico` FOREIGN KEY (`id_tipo_ordem_servico`) REFERENCES `tb_tipo_ordem_servico` (`id_tipo_ordem_servico`) ON DELETE NO ACTION ON UPDATE NO ACTION,
